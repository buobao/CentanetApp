...
public class StaffListBean {
    ...
    public String ServiceEstates; //服务小区
    public String Staff400Tel; //400电话
    public String StaffRemark; //自我评价
    ...
    public void setEmployDate(long employDate) {
