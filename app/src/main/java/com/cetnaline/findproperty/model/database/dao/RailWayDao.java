...
/** 
 * DAO for table "centanet_railway".
*/
public class RailWayDao extends AbstractDao<RailWay, Void> {

    public static final String TABLENAME = "centanet_railway";
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"centanet_railway\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"centanet_railway\"";
        db.execSQL(sql);
    }
