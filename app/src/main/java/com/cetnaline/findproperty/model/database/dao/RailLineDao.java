...
/** 
 * DAO for table "centanet_railline".
*/
public class RailLineDao extends AbstractDao<RailLine, Void> {

    public static final String TABLENAME = "centanet_railline";
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"centanet_railline\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"centanet_railline\"";
        db.execSQL(sql);
    }
