...
/** 
 * DAO for table "centanet_drop_menu".
*/
public class DropMenuDao extends AbstractDao<DropMenu, Void> {

    public static final String TABLENAME = "centanet_drop_menu";

    /**
     * Properties of entity DropMenu.<br/>
    ...
    public DropMenuDao(DaoConfig config) {
        super(config);
    }
    
    public DropMenuDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"centanet_drop_menu\" (" + //
                "\"TYPE\" INTEGER," + // 0: type
                "\"ID\" INTEGER," + // 1: ID
                "\"VALUE\" TEXT," + // 2: Value
                "\"TEXT\" TEXT," + // 3: Text
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"centanet_drop_menu\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, DropMenu entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, DropMenu entity) {
        stmt.clearBindings();
    ...
    @Override
    public DropMenu readEntity(Cursor cursor, int offset) {
        DropMenu entity = new DropMenu( //
    ...
    @Override
    public void readEntity(Cursor cursor, DropMenu entity, int offset) {
    ...
    @Override
    protected final Void updateKeyAfterInsert(DropMenu entity, long rowId) {
        // Unsupported or missing PK type
        return null;
    }
    
    @Override
    public Void getKey(DropMenu entity) {
        return null;
    }

    @Override
    public boolean hasKey(DropMenu entity) {
        // TODO
        return false;
    }
